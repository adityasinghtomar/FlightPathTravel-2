...
<style>
    ...
    <section id="" style=" background-image: url(public/images/flex/visa.jpg);
                    ...
                    <div class="white-box-radius-10 position-relative">
                        ...
                        <nav class="nav-style-1">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link active" id="nav-visa-tab" data-bs-toggle="tab"
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane active" id="nav-visa" role="tabpanel" aria-labelledby="nav-visa-tab">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!display.textContent.trim()) {
        display.textContent = 'Economy'; // Default selection
    }
    ...
    items.forEach(function(item) {
        item.addEventListener('click', function() {
            // Update the paragraph text with the clicked item's text
    ...
    function updateDateDisplay(date) {
        // You can format the date string further here if you want
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var returnDetailParagraph = document.getElementById('dateDisplay1'); // This targets the <p> element
    ...
    function toggleReturnDetail() {
      ...
      if (document.getElementById('tripOneway').checked || document.getElementById('tripMulticity').checked) {
            returnDetailParagraph.classList.add('hidden'); // Hide return details
        } else {
            returnDetailParagraph.classList.remove('hidden'); // Show return details for Round Trip or Multi City
        }
    }
