                ...
                @foreach($data as $key2=>$data1)
					...
					<div class="row search-card-result ">
						<div class="col-md-3">
							...
							<img class="img-fluid "src="<?php print_r($data1->HotelPicture); ?>" onerror="this.src='public/assets/img/hote.avif'"alt="" fetchpriority="low">
						</div>
						<div class="col-md-6">
...
?>
    ...
    font-style: bold;
    font-weight: 700;
"><i class="fas fa-map-marker-alt"></i> <?php print_r($data1->HotelAddress); ?></p>
    ...
    background: #f1f1f1;">
							...
							<div class="text-success">
							    <div class="flight-list-grid-price-time__right__price">
                                        <!--<del><h5 style="margin-bottom:10px;">Pub.Rate {{ $Currency_active->currency_symbol}} -->
                                        <?php 
                                        // $subtotal3= $data1->Price->PublishedPriceRoundedOff;
                                        //  $subtotal4= $subtotal3 / $Currency_active->currency_rates ;echo round($subtotal4, 2);
                                        ?>
                                        <!--</h5></del>-->
