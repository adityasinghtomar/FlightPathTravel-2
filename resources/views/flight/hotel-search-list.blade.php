          ...
          @if(isset($hotels))
                @foreach ($hotels as $hotel)
					...
					<div class="row search-card-result ">
						...
						<div class="col-md-3">
							<img class="img-fluid"src="{{$hotel['ThumbImages']}}"  alt="">

						</div>

						<div class="col-md-6">

						<a href="{{ url('hotel-detail/' . ($hotel['id'] ?? '')) }}"> <h5> {{ $hotel['name'] ?? ''}} </h5></a>
							<div class="review">
                        <?php
						...
						<div class="col-md-3 border-left text-center more-offers" style="border-left: 1px solid #ababab; background: #f1f1f1;">
							...
							<div class="text-success">
							    ...
							    <div class="flight-list-grid-price-time__right__price">
                                        ...
                                        {{  round($hotel['price']) ?? 0}} </h5></del>

                                        <h5 style="margin-bottom:10px;">Off.Rate {{ $Currency_active->currency_symbol ?? ''}}  {{ round($hotel['price']) ?? 0}}
