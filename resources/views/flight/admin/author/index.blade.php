            ...
            @if(isset($posts))    
                    @foreach($posts as $postss)    
                     <tr>
                       ...
                       <td><?php print_r($postss->email);?></td>
                       <td><?php print_r($postss->bio);?></td>

                       <td>
                          <div class="row x-gap-10 y-gap-10 items-center">

                             <div class="col-auto">
                           <a href="{{url('/edit-author'.$postss->id)}}" class="btn btn_theme btn_md">Edit</a>
                                </div>
                            <div class="col-auto">
                           <a href="{{url('/author-delete'.$postss->id)}}" class="btn btn_theme btn_md">Delete</a>
                                </div>
                            <!--<div class="col-auto">-->
