          ...
          <div class="tabs -underline-2 js-tabs">
            ...
            <div class="tabs__content pt-30 js-tabs-content">
              <div class="tabs__pane -tab-item-1 is-tab-el-active">
                ...
                <form action="{{url('/update-author')}}" enctype="multipart/form-data" method="post">
                 @csrf      
                 <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                      <div class="form-input ">
                        ...
                        <input type="text" name="email" value="{{$posts->email}}" required>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Bio Data</label>
                        <input type="text" name="bio" value="{{$posts->bio}}" required>
                      </div>
                    </div>
