        ...
        <div class="py-30 px-30 rounded-4 bg-white custom_shadow">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">All Visa Package</button>
              </div>
        ...
        <tbody>
            @if(isset($flight))    
                    @foreach($flight as $flights)    
                     <tr>
                         <td>@if(isset($flights->visa_id))<?php  $Currency1 =\App\Visa_Model::where('id',$flights->visa_id)->first(); ?> <?php echo $Currency1->visa_name; ?>@endif</td>
                        <td><?php print_r($flights->visa_package);?></td>
                        <td><?php print_r($flights->package_details);?></td>
