@include('flight.admin.db-header')
    <div class="dashboard__main">
      <div class="dashboard__content">
        ...
        <div class="py-30 px-30 rounded-4 bg-white custom_shadow">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">All Tour Enquiry</button>
              </div>
        ...
        <tbody>
            @if(isset($Tour_Enquiry))    
                    @foreach($Tour_Enquiry as $Tour_Enquirys)    
                     <tr>
                       <td><?php echo $Tour_Enquirys->destination; ?></td>
                       <td><?php echo $Tour_Enquirys->interested_in; ?></td>
                       <td><?php echo $Tour_Enquirys->Preferred_Category; ?></td>
                        <td><?php echo $Tour_Enquirys->Preferred_Depart_Date; ?></td>
                        <td><?php echo $Tour_Enquirys->Title; ?></td>
                        <td><?php echo $Tour_Enquirys->Full_name; ?></td>
                        <td><?php echo $Tour_Enquirys->Telephone; ?></td>
                        <td><?php echo $Tour_Enquirys->Email; ?></td>
                        <td><?php echo $Tour_Enquirys->Your_Message; ?></td>
                      </tr>
                    @endforeach
                    @endif
        </tbody>
