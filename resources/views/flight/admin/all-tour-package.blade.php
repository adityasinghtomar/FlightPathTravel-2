        ...
        <div class="py-30 px-30 rounded-4 bg-white custom_shadow">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">All Tour Package</button>
              </div>
        ...
        <tbody>
            @if(isset($flight))    
                    @foreach($flight as $flights)    
                     <tr>
                         <td>@if(isset($flights->tour_id))<?php  $Currency1 =\App\Tour_Model::where('id',$flights->tour_id)->first(); ?> <?php echo $Currency1->tour_name; ?>@endif</td>
                        <td><?php print_r($flights->tour_package_name);?></td>
                        <td><?php print_r($flights->details);?></td>
