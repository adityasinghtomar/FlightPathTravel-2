          ...
          <div class="tabs -underline-2 js-tabs">
            ...
            <div class="tabs__content pt-30 js-tabs-content">
              <div class="tabs__pane -tab-item-1 is-tab-el-active">
                ...
                <form action="{{url('/store-wallet')}}" enctype="multipart/form-data" method="post">
                                                      @csrf      
                ...
                <div class="row">  
                  <div class="col-6">
                    ...
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Wallet Amount</label>
                ...
                <div class="d-inline-block pt-30">
                    <button class="button h-50 px-24 -dark-1 bg-blue-1 text-white">Add Wallet</button>
                </div>
              </div>
