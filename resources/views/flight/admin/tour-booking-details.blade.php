        ...
        <tbody>
            @if(isset($flight))    
                    @foreach($flight as $flights)    
                     <tr>
                         <td><?php echo $Currency1 =\App\Tour_Model::where('id',$flights->tour_id)->first()->tour_name; ?></td>
                        <td><?php echo $Currency1 =\App\Tour_Detail_Model::where('id',$flights->tour_pavkage_id)->first()->tour_package_name; ?></td>
