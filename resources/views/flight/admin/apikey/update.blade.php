          ...
          <div class="tabs -underline-2 js-tabs">
            ...
            <div class="tabs__content pt-30 js-tabs-content">
              <div class="tabs__pane -tab-item-1 is-tab-el-active">
                ...
                <form action="{{url('/update-blog')}}" enctype="multipart/form-data" method="post">
                 @csrf      
                 <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Post Author</label>
                            <?php $post_author =\App\Post_Authors_Model::get(); ?>
                            <select class="form-control demo-select2-placeholder" name="author_id" id="state_id" >
                             @foreach($post_author as $post_authors)
                                <option value="{{$post_authors->id}}">{{$post_authors->name}}</option>
                            @endforeach   
                            </select>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Post category</label>
                            <?php $post_categories =\App\Post_Categories_Model::get(); ?>
                            <select class="form-control demo-select2-placeholder" name="category_id" id="state_id" >
                             @foreach($post_categories as $post_categoriess)
                                <option value="{{$post_categoriess->id}}">{{$post_categoriess->name}}</option>
                            @endforeach   
                            </select>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        ...
                        <input type="text" name="slug" value="{{$posts->slug}}" required>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">is_featured</label>
                        <input type="text" name="is_featured" value="{{$posts->is_featured}}" required>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        ...
                        <select class="form-control demo-select2-placeholder" name="status" >
                            ...
                            <option value="publiced">publiced</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Blog Image</label>
                        <input type="file" name="featured_image_url">
                      </div>
                    </div>
                ...
                <div class="col-12">
                      <div class="form-input ">
                        ...
                        <textarea rows="2" id="default" cols="60"  name="content" value="">{{$posts->content}}</textarea>
                      </div>
                    </div>
                <div class="d-inline-block pt-30">
                    <button class="button h-50 px-24 -dark-1 bg-blue-1 text-white">Update Blog</button>
                </div>
              </div>
              </form>
            </div>
