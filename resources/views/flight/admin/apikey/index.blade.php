@include('flight.admin.db-header')
    <div class="dashboard__main">
      <div class="dashboard__content">
        ...
        <div class="py-30 px-30 rounded-4 bg-white custom_shadow">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">API Credentials</button>
              </div>
        ...
        <tbody>
            @if(isset($posts))    
                    @foreach($posts as $flights)    
                     <tr>
                         <td><?php print_r($flights->id);?></td>
                        <td><?php print_r($flights->api_name);?></td>
                        <td><?php print_r($flights->ClientId);?></td>
                        <td><?php print_r($flights->UserName);?></td>
                        <td><?php print_r($flights->Password);?></td>
                        <td><?php print_r($flights->EndUserIp);?></td>
                        ...
                        <td>
                          <div class="row x-gap-10 y-gap-10 items-center">
                             ...
                             <div class="col-auto">
                           <a href="" id="editCompany" class="btn btn_theme btn_md addAttr" data-toggle="modal" data-target='#practice_modal' data-id="{{$flights->id}}" 
                                style="background-color:blue; color:white;">Edit</a>
                                </div>
        ...
        <div class="modal fade" id="practice_modal">
                        <div class="modal-dialog" style="width:100%;">
                           ...
                           <form action="{{url('/api-update-test')}}" enctype="multipart/form-data" method="post">
                                                      @csrf   
                   ...
                   <div class="row">
                    ...
                    <div class="col-12">
                        <label class="lh-1 text-16 text-light-1" style="padding:16px 1px 15px 12px;"></label>
                                <button class="btn btn_theme btn_md" style="background-color:blue; color:white;">Save</button></div>
                            </div>
                           </form>
                        </div>
                    </div>
