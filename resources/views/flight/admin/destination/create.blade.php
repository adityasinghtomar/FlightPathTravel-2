...
@endif
            <h1 class="text-30 lh-14 fw-600">Add Destination</h1>
          ...
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button
                  ...
                  data-tab-target=".-tab-item-1">Add Destination</button>
              </div>
        </div>
            ...
            <div class="tabs__content pt-30 js-tabs-content">
              <div class="tabs__pane -tab-item-1 is-tab-el-active">
                ...
                <form action="{{url('/store-destination')}}" enctype="multipart/form-data" method="post">
                 @csrf      
                 <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                     ...
                     <div class="col-12">
                      <div class="form-input ">
                        ...
                        <textarea rows="2" cols="60" id="default" name="desc" ></textarea>
                      </div>
                    </div>
              
                <div class="d-inline-block pt-30">
                    <button type="submit" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">Add </button>
                </div>
              </div>
              </form>
            </div>
