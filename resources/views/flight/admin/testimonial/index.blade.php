            ...
            @if(isset($posts))    
                    @foreach($posts as $postss)    
                     <tr>
                       ...
                       <td><?php print_r($postss->content);?></td>
                       <td><?php print_r($postss->ratting);?></td>

                       <td>
                          <div class="row x-gap-10 y-gap-10 items-center">

                             <div class="col-auto">
                           <a href="{{url('/edit-review'.$postss->id)}}" class="btn btn_theme btn_md">Edit</a>
                                </div>
                            <div class="col-auto">
                           <a href="{{url('/review-delete'.$postss->id)}}" class="btn btn_theme btn_md">Delete</a>
                                </div>
                            <!--<div class="col-auto">-->
