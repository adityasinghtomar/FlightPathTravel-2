      ...
      <div class="dashboard__content">
        <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-32">
          <div class="col-auto">
            ...
            <h1 class="text-30 lh-14 fw-600">Add Visa Package</h1>
          ...
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button
                  ...
                  data-tab-target=".-tab-item-1">Add Visa Package</button>
              </div>
        </div>
            ...
            <div class="tabs__content pt-30 js-tabs-content">
              <div class="tabs__pane -tab-item-1 is-tab-el-active">
                ...
                <form action="{{url('/visa-package-store')}}" enctype="multipart/form-data" method="post">
                                                      @csrf   
                 <div class="row">  
                 <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Visa </label>
                        <select class="form-control demo-select2-placeholder" name="visa_id" id="state_id" >
                             <option value="">Select Visa</option>
                            @foreach($flight as $state_)
                             <option value="{{$state_->id}}">{{__($state_->visa_name)}}</option>
                             @endforeach
                        </select>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Visa Package Name</label>
