      ...
      <div class="dashboard__content">
        ...
        <div class="py-30 px-30 rounded-4 bg-white custom_shadow">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">All Mark-Up</button>
              </div>
        ...
        <tbody>
            @if(isset($commision))    
                    @foreach($commision as $flights)    
                     <tr>
                       <td><?php echo $comm= \App\Markup_Model::where('id',$flights->markup_id)->first()->name; ?></td>
                        ...
                        <td>
                          <div class="row x-gap-10 y-gap-10 items-center">
                           ...
                           <a href="" id="editCompany" class="addAttr" data-toggle="modal" data-target='#practice_modal' data-id="{{$flights->id}}" 
                                data-name="{{$flights->markup_id}}" data-commision="{{$flights->user_id}}"
                                >Edit</a>
                                </div>
        ...
        <div class="modal fade" id="practice_modal">
                        <div class="modal-dialog" style="width:100%;">
                           ...
                           <form action="{{url('/markup-apply-update')}}" enctype="multipart/form-data" method="post">
                                                      @csrf   
                   ...
                   <div class="row">
                    <div class="col-6">
                      <div class="form-input ">
                        ...
                        <select class="form-control demo-select2-placeholder" name="markup_id" id="name" >
                            <option value="">Select Mark-up</option>
                            @foreach($commisionss as $commisions)
                    ...
                    <div class="col-6">
                      <div class="form-input ">
                        ...
                        <select class="form-control demo-select2-placeholder" name="user_id" id="commision" >
