        ...
        <div class="py-30 px-30 rounded-4 bg-white custom_shadow">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">All Commision</button>
              </div>
            ...
            @if(isset($flight))    
                    @foreach($flight as $flights)    
                     <tr>
                        ...
                        <td><?php print_r($flights->currency_code);?></td>
                        <td><?php print_r($flights->currency_name);?></td>
                        <td><?php print_r($flights->currency_symbol);?></td>
