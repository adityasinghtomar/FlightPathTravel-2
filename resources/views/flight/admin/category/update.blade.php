          ...
          <div class="tabs -underline-2 js-tabs">
            ...
            <div class="tabs__content pt-30 js-tabs-content">
              <div class="tabs__pane -tab-item-1 is-tab-el-active">
                ...
                <form action="{{url('/update-category')}}" enctype="multipart/form-data" method="post">
                 @csrf      
                 <div class="row">
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Name</label>
                        <input type="text" name="title" value="{{$posts->name}}" required>
                        <input type="hidden" name="id" value="{{$posts->id}}" required>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">Dexcription</label>
                        <input type="text" name="desc" value="{{$posts->description}}" required>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-input ">
                        <label class="lh-1 text-16 text-light-1">parent category</label>
                        <input type="text" name="parant" value="{{$posts->parent_category}}" required>
                      </div>
                    </div>
