...
<section>
    ...
    padding: 15px;
    margin-top: 20px;">
            <form action="{{url('/visa-enquiry')}}" enctype="multipart/form-data" method="post" style="padding:50px;">
                 @csrf
    ...
    font-weight: 600;">Country</label>
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            <label style="font-size: 18px;
    font-weight: 600;"> Visa type</label>
                            <select class="form-control" name="Visa_type">
                                <option>--SELECT Visa Type -- </option>
                               
                               
                                <option value="Single Visa">Single Visa</option>
                     ...
                     <div class="col-md-3">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="tel" name="mobile" placeholder="Phone Number*" class="form-control" required>
                        </div>
                    </div>
                  <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" >
                           ...
                           <textarea name="message" id="" class="form-control" cols="10" rows="5" placeholder="Enter Your Message"></textarea>
                        </div>
