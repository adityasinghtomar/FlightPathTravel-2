                    ...
                    <div class="theme_search_form_area">
                        <div class="theme_search_form_tabbtn">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{url('/Visa-list')}}" class="nav-link active"><i class="fas fa-passport"></i> Visa </a>
                                            ...
                                            <div class="cruise_item_inner_content">
                                                <div class="cruise_content_top_wrapper">
                                                    <div class="cruise_content_top_left">
                                                        <ul>
                                                            <li>{{$tour_list->duration}} days <i class="fas fa-circle"></i></li>
                                                        </ul>
                                                        <h4>{{$tour_list->visa_name}}</h4>
                                                       </div>
                                                ...
                                                <div class="cruise_content_middel_wrapper">
                                                    <div class="cruise_content_middel_left">
                                                        <h5>Visa Type : {{$tour_list->visa_type}}</h5>
                                                    </div>
                                                    <div class="cruise_content_middel_right">
                                                        <h3>${{$tour_list->amount}}	<sub>/Per person</sub></h3>
                                                    </div>
                                                </div>
