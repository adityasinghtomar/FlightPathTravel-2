...
@endphp
    ...
    <?php  $Segments = $dat2->Segments; ?>
     ...
     @foreach( $Segments as $setkey => $Segment)
...
<div class="col-md-9">
    <div class="flight-list-grid">
      @if(isset($ress) && isset($unique_fareclasses))
        ...
        <?php  $Segments = $dat2->Segments; ?>
        <?php  $FareRules = $dat2->FareRules; ?>
         @foreach( $Segments as $key_new => $Segment)
     ...
     <!--   </div>-->
            <div class="flight-list-grid-airline">
                <div class="flight-list-grid-airline__left">
                    <div class="flight-list-grid-airline__left__img">
                        <div class="">
                            <img src="public/assets/AirlineLogo/<?php echo $Segm->Airline->AirlineCode;?>.gif" style="height:50px;">
            ...
            <div class="flight-list-grid-more-details-book-now mt-15">
                ...
                <div class="flight-list-grid-more-details-book-now__center">
                     <!--<h5><img src="public/images/seat.png" style="width:30px;height:30px;"> : <?php if(isset($Segm->NoOfSeatAvailable)) { echo $Segm->NoOfSeatAvailable; } ?> Seat Available</h5>-->
...
$('.close').click(function(){
    ...
    <div class="custom-modal-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="border-bottom:2px solid #d95313f2;margin:10px ; ">
                <!-- Origin details -->
                <div class="col-md-4">
                    <p>From</p>
    ...
    border: 2px solid #bfbcbc;"></div>
        ...
        <div class="container-fluid">
            ...
            <div>
                ...
                <table>
                    <td>
                        | Reissue Charge <span><?php   if(isset($dat2->PenaltyCharges->ReissueCharge)) { echo $dat2->PenaltyCharges->ReissueCharge; } ?></span>
                        | Cancellation Charge <span><?php if(isset($dat2->PenaltyCharges->CancellationCharge)) { echo $dat2->PenaltyCharges->CancellationCharge; } ?> |</span>
                    </td> 
                    <!-- Add more details as needed -->
                </table>
            </div>
