                                                        ...
                                                        <td
                                                            ...
                                                            <h1
                                                                ...
                                                                style="margin: 0px; color: #e98c06; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 30px; "><strong>Your
                                                                   Hotel Booking Detail</strong></h1>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                ...
                                                                <h1
                                                                    class="v-color v-text-align v-font-size"
                                                                    style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 26px; "><strong>Hotel Details</strong></h1>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                               ...
                                                               <img src="image/hotel.jpg" style="width:100%;height:160px;" alt="">
                                                ...
                                                <table id="u_content_text_5"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:0px 20px 0px 10px;font-family:'Open Sans',sans-serif;"
                                                                align="left">

                                                                <div
                                                                    class="v-color v-text-align v-font-size"
                                                                    style="font-size: 16px; color: #22255e; line-height: 5%; text-align: right; word-wrap: break-word;">
                                                                    <h3
                                                                        style="line-height: 140%;"><b>Sheraton Test</b><br>
                                                                   ...
                                                                   <p>
                                                                    test hotel, 3432432, Mumbai, 232132323
                                                                   </p>
                                                                   <h3 style="margin:20px 0px 20px 0px;">Free cancellation</h3>
                                                                   <p style="margin:20px 0px 20px 0px;">Cancel your booking at any time</p>
