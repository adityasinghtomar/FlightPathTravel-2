                ...
                <div class="col-lg-8">
                    <div class="news_detail_wrapper">
                        <div class="news_details_content_area">
                            <img src="{{ asset('public/images/'.$post->featured_image_url)}}" alt="img">
                            <h2>{{ $post->title }}</h2>
                            {!! $post->content !!}
                        ...
                        <div class="news_details_right_item">
                            ...
                            <div class="recent_news_item">
                                <div class="recent_news_img" >
                                    <img src="{{ asset('public/images/'.$row->featured_image_url) }}" alt="img">
                                </div>
                                <div class="recent_news_text">
                                    <h5><a href="{{ route('blog', ['slug' => $row->slug]) }}">{{ $row->title }}</a></h5>
