...
<div class="preloader">
 ...
 <style>
    ...
    <section id="" style=" background-image: url(public/images/flex/tours.jpg);
                    ...
                    <div class="white-box-radius-10 position-relative">
                        ...
                        <nav class="nav-style-1">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link active" id="nav-tours-tab" data-bs-toggle="tab"
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane active" id="nav-tours" role="tabpanel"
