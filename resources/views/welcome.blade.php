                                                ...
                                                <table id="u_content_heading_2"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                                align="left">

                                                                <h1
                                                                    class="v-color v-text-align v-font-size"
                                                                    style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 26px; "><strong>Details</strong></h1>
                                ...
                                <div
                                    ...
                                    <div id="u_column_8"
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="v-col-border"
                                                style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 5px solid #e98c06;border-right: 0px solid transparent;border-bottom: 30px solid #e98c06;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                                ...
                                                <table id="u_content_text_4"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 0px 20px;font-family:'Open Sans',sans-serif;"
                                                                align="left">

                                                                <div
                                                                    class="v-color v-text-align v-font-size"
                                                                    style="font-size: 16px; color: #22255e; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p
                                                ...
                                                <table id="u_content_text_12"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 0px 20px;font-family:'Open Sans',sans-serif;"
                                                                align="left">
                                                ...
                                                <table id="u_content_text_14"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px 20px;font-family:'Open Sans',sans-serif;"
                                                                align="left">
                                    ...
                                    <div id="u_column_9"
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="v-col-border"
                                                style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 30px solid #e98c06;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                                ...
                                                <table id="u_content_image_4"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                                align="left">
                                    ...
                                    <div id="u_column_10"
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="v-col-border"
                                                style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 5px solid #e98c06;border-bottom: 30px solid #e98c06;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                                ...
                                                <table id="u_content_text_5"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:30px 20px 0px 10px;font-family:'Open Sans',sans-serif;"
                                                                align="left">

                                                                <div
                                                                    class="v-color v-text-align v-font-size"
                                                                    style="font-size: 16px; color: #22255e; line-height: 140%; text-align: right; word-wrap: break-word;">
                                                                    <p
                                                ...
                                                <table id="u_content_text_10"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:5px 20px 0px 10px;font-family:'Open Sans',sans-serif;"
                                                                align="left">
                                                ...
                                                <table id="u_content_text_11"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 30px;font-family:'Open Sans',sans-serif;"
                                                                align="left">
                                                ...
                                                <table id="u_content_button_1"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:50px 10px 25px;font-family:'Open Sans',sans-serif;"
                                                                align="left">
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div
                                                                    align="center">
                                                                    <div
                                                                        style="display: table; max-width:167px;">
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p
                                                                        style="font-size: 14px; line-height: 170%;">UNSUBSCRIBE
                                                                        &nbsp; |
                                                                        &nbsp;
                                                                        PRIVACY
                                                                        POLICY
                                                                        ...
                                                                        WEB</p>
                                                                    <p
                                                                        style="font-size: 14px; line-height: 170%;">&nbsp;</p>
                                                                    <p
                                                                        style="font-size: 14px; line-height: 170%;">Lorem
                                                                        ipsum
                                                                        dolor
                                                                        sit
                                                                        amet,
